      ...
      <div>
        ...
        <div id="about" class="about">
            <div class="grid-item item-1">
                  ...
                  <p>Every tuesday and thursday at <mark>17:15</mark> we hosts Conversation Corners for culutural and language exchange. </p> 
                  <p>We also offer <mark>free fika</mark> for all our members!</p>
            </div>
            <div id="item-2" class="grid-item item-2">
                  <h1>Asienkunskap</h1>
